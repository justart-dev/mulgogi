...
FISH_DATA: List[Fish] = [
    ...
    Fish("whale", "독고래", "   __---__\n  /  O O  \\\n |    >    |\n  \\_______/", 50.0, 150.0, 5, 5, "night", "rainy", 2000, 1000),
]

SPOT_DATA: List[Spot] = [
    Spot("pond", "연몰", 1, ["carp", "crucian", "trout"], "조용한 연몰. 초보자에겐 딱 좋다."),
    Spot("river", "강가", 3, ["carp", "trout", "catfish", "pike"], "흐르는 물에서 낚시를 도전해보자."),
    Spot("lake", "호숫", 5, ["bass", "pike", "eel", "salmon"], "넓은 호숫에는 큰 물고기가 숨어있다."),
    Spot("sea", "바다", 8, ["bass", "eel", "salmon", "whale"], "끝을 알 수 없는 바다. 강한 낚싯대가 필요하다."),
]
...
BAIT_DATA: List[Bait] = [
    ...
    Bait("cricket", "게라지", 15, 0.05, None, "뱀스와 메기에 잘 놀진다."),
