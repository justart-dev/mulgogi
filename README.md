...
- **19종의 다양한 물고기** — 연몿, 강, 호수, 바다바에 생태를 바꼬가며 사는 물고기들
- **픽셀 경우 아트** — 종류별로 색감을 달리한 터미널 스프라이트
- **성장 시스템** — 레벨/경험치, 낚시터 해제, 납싯대/미끼 구매
- **도감 & 업적** — 잡은 물고기를 모으고 칭호를 얻으세요
- **스크린샷 공유** — `s` 키로 내 어떤 물고기를 잡았는지 ASCII 카드로 저장
- **털의 컬러 테마** — 차콜 배경에 민트 그린 악센트
